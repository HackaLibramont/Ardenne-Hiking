 ...
 */
public class TracksRequest extends JsonRequest<JsonArray>
{
     ...
     */
    public TracksRequest( Response.Listener<JsonArray> listener, Response.ErrorListener errorListener) {
        super(Method.GET, "http://192.168.1.59:8080/ardennes-hicking/api/search", null, listener, errorListener);
        this.setShouldCache(true);
        Log.d(TAG, "created tracks request: ");
    }
    ...
    protected Response<JsonArray> parseNetworkResponse(NetworkResponse response) {
        try {
            String jsonString =
             ...
             return Response.success(JsonElement.readFrom(jsonString).asJsonArray()
                    ,
